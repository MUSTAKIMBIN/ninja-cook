        ...
        <div>
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="lg:max-w-xl">
                <h1 className="mb-10 text-white text-2xl lg:text-5xl font-bold">Discover an exceptional cooking class tailored for you!</h1>
               ...
               <div className='space-x-4'>
                ...
                <button className='text-white font-semibold py-3 px-6 border-[1px] border-[#E5C287] rounded-3xl'>Our Feedback</button>
               </div>
              </div>
            </div>
          </div>
