        ...
        <div>
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="lg:max-w-xl">
                <h1 className="mb-10 text-gray-500 text-2xl lg:text-5xl font-bold">Discover an exceptional cooking class tailored for you!</h1>
                <p className="mb-5 text-base text-gray-200">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptatum sit soluta nostrum?</p>
